...
public class Token {
    ...
    public static final Token sexTok = new Token(TokenType.Sex, "sex"); // this is ours :)
    public static final Token maleTok = new Token(TokenType.Male, "m"); 
    public static final Token femaleTok = new Token(TokenType.Female, "f"); 
    ...
    public static final Token ifNotTok = new Token(TokenType.IfNot, "ifnot"); 
    ...
    public static final Token superPlusTok = new Token(TokenType.SuperPlus, "+*"); 
